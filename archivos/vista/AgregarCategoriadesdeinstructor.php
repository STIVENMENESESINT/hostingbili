...
<body>
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    ...
                    <h1>solicitud Agregar Nueva Categoría</h1>
        <form id="formAgregarCategoria">
            ...
            <a href="listarcategoriadesdeinstructor.php" class="btn btn-primary" id="btnRegresar">
                    Regresar
                </a>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function() {
            // Acción al hacer clic en el botón de agregar categoría
            $(document).on("click", "#btnAgregarCategoria", function() {
                // Enviar solicitud AJAX para agregar categoría
                $.post("../../include/ctrlIndex3.php", {
                    ...
                    if (data.rst == "1") {
                        ...
                        $("#formAgregarCategoria")[0].reset(); // Limpiar el formulario
                    } else {
                        alert('Error al agregar la categoría: ' + data.ms);
                    }
                }, 'json');
            });
        });
