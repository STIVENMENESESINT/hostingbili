...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Certificación de Estudios</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Certificación de Estudios</h2>
    <form action="procesar_certificacion.php" method="POST">
        ...
        <label for="fecha_inicio">Fecha de inicio del curso:</label><br>
        <input type="date" id="fecha_inicio" name="fecha_inicio" required><br><br>

        <label for="fecha_fin">Fecha de finalización del curso:</label><br>
