...
<body>
                ...
                <fieldset>
                    ...
                    <!-- Selector de rol de instructor -->
                    <div class="form-group">
                        <label for="rol">Rol del instructor:</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="file-input" type="file" id="archivo" name="archivo" accept=".pdf, .doc, .docx">
                        <span class="file-name">PDF, DOC, DOCX. (Máx. 10MB)</span>
                    </div>

                    <!-- Botón de enviar formulario -->
                    <button type="button" class="btn btn-primary" id="btnEnviarFormulario">Enviar Mensaje</button>
                </fieldset>
            </form>
...
<script>
    ...
    <script>
        ...
        function listarMensajes() {
            $.post('../../include/ctrlIndex3.php', { action: 'ListarMensajesinstructor' }, function(data) {
                if (data.rst == "1") {
