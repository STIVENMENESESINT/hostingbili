                        ...
                        <?php foreach ($mcer as $nivel) { ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <!-- Botones de acción -->
                                    <button type="button" class="btn btn-primary btn-editar-mcer"
                                        data-id="<?php echo $nivel['id_mcer']; ?>">Editar</button>
                                        <button type="button" class="btn btn-info btn-detalles-mcer"
        data-id="<?php echo $nivel['id_mcer']; ?>"
        onclick="window.location.href='detallemcerinstructor.php?id=<?php echo $nivel['id_mcer']; ?>';">
    Detalles
</button>
