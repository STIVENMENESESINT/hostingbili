...
<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Actualizar Secciones</h2>
</div>
...
<style>
        ...
        .input {
            border-radius: 5px; /* Agregar bordes redondeados al campo de entrada */
            margin-bottom: 1em; /* Ajustar el espacio inferior del campo de entrada */
        }
        .button {
