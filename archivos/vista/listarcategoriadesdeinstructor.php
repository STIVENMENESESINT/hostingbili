...
<head>
    ...
    <title>listar categorias desde instructor</title>
    ...
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                ...
                </div>    <a href="AgregarCategoriadesdeinstructor.php" class="btn btn-success">Agregar Solicitud De Crear Nueva  Categoria</a> 
                </div>
            </div>
        </div>
