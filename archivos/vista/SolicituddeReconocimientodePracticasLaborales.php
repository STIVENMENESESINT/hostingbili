...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Reconocimiento de Prácticas Laborales</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Reconocimiento de Prácticas Laborales</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="empresa">Empresa donde realizó las prácticas:</label><br>
        <input type="text" id="empresa" name="empresa" required><br><br>

        <label for="fecha_inicio">Fecha de inicio de las prácticas:</label><br>
        <input type="date" id="fecha_inicio" name="fecha_inicio" required><br><br>

        <label for="fecha_fin">Fecha de fin de las prácticas:</label><br>
        <input type="date" id="fecha_fin" name="fecha_fin" required><br><br>

        <label for="descripcion">Descripción de las actividades realizadas:</label><br>
        <textarea id="descripcion" name="descripcion" rows="4" required></textarea><br><br>

        <label for="documento_adjunto">Documento que respalda las prácticas (opcional):</label><br>
        <input type="file" id="documento_adjunto" name="documento_adjunto"><br><br>
