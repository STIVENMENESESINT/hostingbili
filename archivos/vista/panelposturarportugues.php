        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    ...
                    <h1>postulacion de cursos PORTUGUES  </h1>
                    ...
                    <!-- Menú principal -->
                        ...
                        <div class="col-sm-4">
                            ...
                            <li>
                                    <a href="matriculados.php" class="nav-link nav-item-hover">
                                        ...
                                        <span class="nav-item">A0: Principiante  </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="matriculados.php" class="nav-link nav-item-hover">
                                        <i class="fas fa-graduation-cap fa-fw fa-lg"></i>
                                        <span class="nav-item">A1-A2: Básico  </span>
                                    </a>
                                </li>
                            ...
                            <li>
                                    <a href="matriculados.php" class="nav-link nav-item-hover">
                                        <i class="fas fa-graduation-cap fa-fw fa-lg"></i>
                                        <span class="nav-item">A2-B1: Pre-intermedio  </span>
                                    </a>
                                </li>
                        ...
                        <div class="col-sm-4">
                            ...
                            <li>
                                    <a href="matriculados.php" class="nav-link nav-item-hover">
                                        <i class="fas fa-graduation-cap fa-fw fa-lg"></i>
                                        <span class="nav-item">B1: Intermedio  </span>
                                    </a>
                                </li>
                            ...
                            <li>
                                    <a href="matriculados.php" class="nav-link nav-item-hover">
                                        <i class="fas fa-graduation-cap fa-fw fa-lg"></i>
                                        <span class="nav-item">B2: Intermedio-Alto  </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="matriculados.php" class="nav-link nav-item-hover">
                                        <i class="fas fa-graduation-cap fa-fw fa-lg"></i>
                                        <span class="nav-item">C1-C2: Avanzado  </span>
                                    </a>
                                </li>
                    ...
                    <!-- Navbar content -->
                    <li>
                        <a href="panelpostulacioncursos.php">
