...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Cambio de Modalidad de Estudio</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Cambio de Modalidad de Estudio</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="curso">Curso o programa actual:</label><br>
        <input type="text" id="curso" name="curso" required><br><br>

        <label for="modalidad_actual">Modalidad actual:</label><br>
        <select id="modalidad_actual" name="modalidad_actual" required>
            <option value="">Seleccionar modalidad actual</option>
            <option value="Presencial">Presencial</option>
            <option value="Virtual">Virtual</option>
            <option value="Semi-presencial">Semi-presencial</option>
        </select><br><br>

        <label for="nueva_modalidad">Nueva modalidad solicitada:</label><br>
        <select id="nueva_modalidad" name="nueva_modalidad" required>
            <option value="">Seleccionar nueva modalidad</option>
            <option value="Presencial">Presencial</option>
            <option value="Virtual">Virtual</option>
            <option value="Semi-presencial">Semi-presencial</option>
        </select><br><br>
