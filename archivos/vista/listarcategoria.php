...
<body>
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    ...
                    <button type="button" class="btn btn-primary btn-Agregar-categoria" data-id="<?php echo $categoria['id_categoria']; ?>" onclick="window.location.href='agregarcategoria.php';">crear</button>
                    ...
                    <?php foreach ($categorias as $categoria) { ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <!-- Botones de acción -->
                                    <button type="button" class="btn btn-primary btn-editar-categoria"
                                        data-id="<?php echo $categoria['id_categoria']; ?>">Editar</button>
        ...
        onclick="window.location.href='EliminarCategoria.php?id=<?php echo $categoria['id_categoria']; ?>';">Eliminar</button>
