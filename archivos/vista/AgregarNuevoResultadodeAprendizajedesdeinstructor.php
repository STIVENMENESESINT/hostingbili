...
<head>
    ...
    <title>nuevo resultado de aprendizaje desde instructor</title>
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    ...
                    <h1>solicitud Agregar Nuevo Resultado de Aprendizaje</h1>
        <form id="formAgregarResultadoAprendizaje">
            <div class="form-group">
                <label for="nombre">Nombre:</label>
                <input type="text" class="form-control" id="nombre" name="nombre" required>
            </div>
            <div class="form-group">
                <label for="id_competencia">ID de Competencia:</label>
                <input type="number" class="form-control" id="id_competencia" name="id_competencia" required>
            </div>
            <button type="button" class="btn btn-primary" id="btnAgregarResultadoAprendizaje">
...
?>
    ...
    <a href="listarresultadosaprendizajedesdeinstructor.php">
    ...
    <script>
        $(document).ready(function() {
            // Acción al hacer clic en el botón de agregar resultado de aprendizaje
            $(document).on("click", "#btnAgregarResultadoAprendizaje", function() {
                // Enviar solicitud AJAX para agregar resultado de aprendizaje
                $.post("../../include/ctrlIndex3.php", {
                    action: 'AgregarResultadoAprendizaje',
                    nombre: $("#nombre").val(),
                    id_competencia: $("#id_competencia").val()
                    ...
                    if (data.rst == "1") {
                        alert('Resultado de aprendizaje agregado con éxito');
                        $("#formAgregarResultadoAprendizaje")[0].reset(); // Limpiar el formulario
                    } else {
                        alert('Error al agregar el resultado de aprendizaje: ' + data.ms);
                    }
                }, 'json');
            });
        });
