...
<body>
    <div class="layout">
        ...
        <div class="layout__content">
            ...
            <h1> solicitud Agregar Nueva Ficha </h1>
                <div id="contenido">
            ...
            <div class="form-group">
                <label for="id_programaformacion">Codigo Del Programa De Formación:</label>
                <input type="number" class="form-control" id="id_programaformacion" name="id_programaformacion" required>
            </div>
...
<body>
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>
                    <a href="editarfichainstructor.php?id_ficha=' . $row['id_ficha'] . '" class="btn btn-sm btn-primary">Editar</a>
                    <a href="detallefichainstructor.php?id_ficha=' . $row['id_ficha'] . '" class="btn btn-sm btn-info">Detalles</a>
                  </td>';
            echo '</tr>';
        }
    } else {
    ...
    </div><a href="listarfichadesdeinstructor.php">
