...
<head>
    ...
    <title>agregar tipos de documento </title>
...
<body>
    <div class="layout">
        ...
        <form id="formAgregarTipoDocumento">
            ...
            <button type="button" class="btn btn-primary" id="btnAgregarTipoDocumento">
    ...
    <script>
        $(document).ready(function() {
            // Acción al hacer clic en el botón de agregar tipo de documento
            $(document).on("click", "#btnAgregarTipoDocumento", function() {
                // Enviar solicitud AJAX para agregar tipo de documento
