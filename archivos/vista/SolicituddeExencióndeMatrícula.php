...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Exención de Matrícula</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Exención de Matrícula</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="documentos_adjuntos">Documentos adjuntos (si aplica):</label><br>
        <input type="file" id="documentos_adjuntos" name="documentos_adjuntos"><br><br>
