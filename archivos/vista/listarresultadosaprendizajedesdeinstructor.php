    ...
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    <h1>Agregar Nuevo Resultado de Aprendizaje</h1>
        ...
        $(document).ready(function () {
                            ...
                            $('#tablaResultados').append(
                                `<tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btnEliminar" data-id="${resultado.id_resultado_aprendizaje}">Eliminar</button>
                                    </td>
                                </tr>`
                            );
                        });
            ...
            $(document).on('click', '.btnEliminar', function () {
                ...
                if (confirm('¿Estás seguro de eliminar este resultado de aprendizaje?')) {
                    $.post('../../include/ctrlIndex3.php', {action: 'EliminarResultadoAprendizaje', id_resultado_aprendizaje: id}, function (data) {
                        alert(data.ms);
                        if (data.rst === "1") {
                            listarResultados();
                        }
