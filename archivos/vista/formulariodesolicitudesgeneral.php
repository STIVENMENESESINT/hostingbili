...
<body>
    ...
    <h1>Formulario General de Solicitudes</h1>
    ...
    <form action="procesar_cambio_carrera.php" method="POST" enctype="multipart/form-data">
        ...
        <select id="tipo_solicitud" name="tipo_solicitud" required>
            ...
            <option value="solicitud crear un programa de formacion ">solicitud crear un programa de
                formacion </option>
            <option value="Solicitud de Aplazamiento de Exámenes">Solicitud de Aplazamiento de Exámenes
            </option>
            <option value="Solicitud de Cambio de programa de formacion">Solicitud de Cambio de programa
                de formacion</option>
            <option value="Solicitud de inscripcion">Solicitud de inscripcion </option>
            <option value="Solicitud de Reconocimiento de Créditos">Solicitud de Reconocimiento de
                Créditos</option>
            <option value="Solicitud de Beca">Solicitud de Beca</option>

            <option value="Solicitud de Reconocimiento de Prácticas Laborales">Solicitud de
                Reconocimiento de Prácticas Laborales</option>

            <option value="Solicitud de Revisión de Calificaciones">Solicitud de Revisión de resultados
                de aprendizaje</option>
            <option value="Solicitud de Certificados de Estudios">Solicitud de Certificados de Estudios
            </option>
            <option value="Solicitud de Ausencia por Enfermedad">Solicitud Excusa de Ausencia por
                Enfermedad</option>
            ...
            <option value="Solicitud de Extensión de Plazo para Entrega de Trabajos">Solicitud de
                Extensión de Plazo para Entrega de Trabajos</option>
        ...
        $(document).ready(function() {
            $('#tipo_solicitud').change(function() {
                ...
                if (selectedOption ===
                    'Solicitud de Reconocimiento de Prácticas Laborales') {
        ...
        <div class="modal fade" id="modalSolicitudPracticas" tabindex="-1"
            aria-labelledby="modalSolicitudPracticasLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudPracticasLabel">Solicitud de
                            Reconocimiento de Prácticas Laborales</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudPracticas" method="POST" action="procesar_solicitud.php">
                            <h3>Estimado Aprendiz:</h3>
                            <p>El SENA tiene el gusto de presentar el programa de Prácticas, el cual
                                busca dar la oportunidad a nuestros estudiantes de realizar su práctica
                                en diferentes organizaciones del Área metropolitana y a nivel nacional,
                                con el fin de apoyar y fortalecer los diferentes procesos
                                organizacionales.</p>
                            <p>Relacionamos los datos básicos para proceder con la solicitud de
                                practicantes, donde se busca ofrecer un usuario y clave de acceso al
                                aplicativo, que posteriormente le permitirá publicar ofertas, consultar
                                las hojas de vida de los estudiantes que se postulen para realizar el
                                proceso de selección, y evaluar a los estudiantes al momento de terminar
                                su práctica:</p>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_practicas" name="motivo_practicas" rows="4" cols="50"
                                    required></textarea>
                            </div>

                            <div class="form-group">
                                <label for="num_estudiantes">Número de estudiantes a
                                    entrevistar:</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="disponibilidad_horaria" name="disponibilidad_horaria" rows="4"
                                    required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="actividades_desarrollar" name="actividades_desarrollar" rows="4"
                                    required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="lugar_practica">Lugar en que se desarrollará la
                                    práctica:</label>
                                <input type="text" id="lugar_practica" name="lugar_practica" required>
                            </div>

                            <div class="form-group">
                                <label>¿Se realizará contrato de aprendizaje (ley 789 de
                                    2002)?</label><br>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" id="modalidad_trabajo_grado" name="modalidad_practica[]"
                                    value="Conducente a Trabajo de Grado">
                                <label for="modalidad_trabajo_grado">Conducente a Trabajo de
                                    Grado</label><br>
                                <input type="checkbox" id="modalidad_no_trabajo_grado" name="modalidad_practica[]"
                                    value="No Conducente a Trabajo de Grado">
                                <label for="modalidad_no_trabajo_grado">No Conducente a Trabajo de
                                    Grado</label>
                            </div>

                            <p><strong>Nota:</strong> La información suministrada en el presente
                                formulario se tratará conforme a lo establecido en la Ley 1581 de 2012 y
                                su Decreto reglamentario 1377 de 2013.</p>

                            <p>Para constancia se firma en Pereira a los <input type="date" id="fecha_firma"
                                    name="fecha_firma" required>.</p>
        ...
        <div class="modal fade" id="modalSolicitudRevision" tabindex="-1" aria-labelledby="modalSolicitudRevisionLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudRevisionLabel">Solicitud de Revisión
                            de Resultados de aprendizaje</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudRevision" method="POST" action="procesar_solicitud.php">
                            <h3>Estimado Aprendiz:</h3>
                            <p>A continuación, puede realizar su solicitud de revisión de resultados
                                aprendizaje:</p>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tipodedocumento" name="tipodedocumento" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="emailsecundario" name="emailsecundario" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="codigoaprendiz" name="codigoaprendiz" class="form-control"
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo" name="motivo" rows="4" cols="50" class="form-control"
                                    required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_revision" name="motivo_revision" rows="4" cols="50"
                                    required></textarea>
                            </div>
        ...
        <div class="modal fade" id="modalSolicitudCertificados" tabindex="-1"
            aria-labelledby="modalSolicitudCertificadosLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudCertificadosLabel">Solicitud de
                            Certificación de Estudios</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudCertificados" method="POST" action="procesar_solicitud.php">
                            <h3>Estimado Estudiante:</h3>
                            <p>A continuación, puede realizar su solicitud de certificación de estudios:
                            </p>
                            <div class="form-group">
                                <label for="nombre">Nombre Completo:</label>
                                <input type="text" id="nombre" name="nombre" class="form-control" required>
                            ...
                            <div class="form-group">
                                <label for="id_tipo_certificacion">Tipo de Certificación
                                    Solicitada:</label>
        ...
        <div class="modal fade" id="programaFormacionModal" tabindex="-1" role="dialog"
            aria-labelledby="programaFormacionModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="programaFormacionModalLabel">Solicitud Crear un
                            Programa de Formación (Empresa)</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formSolicitud" method="POST" action="procesar_solicitud.php">
                            ...
                            <p>El SENA tiene el gusto de brindar cursos para la comunidad, el cual busca
                                dar la oportunidad de realizar su formación profesional en diferentes
                                programas a nivel nacional, con el fin de apoyar y fortalecer los
                                diferentes procesos organizacionales. Adjunto podrá encontrar
                                información detallada de los diferentes programas académicos con las
                                características generales.</p>
                            <p>Relacionamos los datos básicos para proceder con la solicitud de
                                programas de formación, donde se busca ofrecer un usuario y clave de
                                acceso al aplicativo, que posteriormente le permitirá aplicar a ofertas:
                            </p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="sector_economico" name="sector_economico" class="form-control"
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="id_programa_matricula">Programa al que se desea
                                    inscribir:</label>
                                <select id="id_programa_matricula" name="id_programa_matricula" class="form-control"
                                    required>
        ...
        $(document).ready(function() {
            $('#tipo_solicitud').change(function() {
                ...
                if (selectedOption === 'Solicitud de Ausencia por Enfermedad') {
                    $('#modalSolicitudAusenciaEnfermedad').modal(
                        'show'); // Abre el modal
                }
            });
        });
        ...
        <div class="modal fade" id="modalSolicitudAusenciaEnfermedad" tabindex="-1"
            aria-labelledby="modalSolicitudAusenciaEnfermedadLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudAusenciaEnfermedadLabel">Solicitud de
                            Ausencia por Enfermedad</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudAusenciaEnfermedad" method="POST" action="procesar_solicitud.php">
                            <h3>Estimado Estudiante:</h3>
                            <p>A continuación, puede realizar su solicitud de ausencia por enfermedad:
                            </p>
                            <div class="form-group">
                                <label for="nombre">Nombre Completo:</label>
                                <input type="text" id="nombre" name="nombre" class="form-control" required>
                            ...
                            <div class="form-group">
                                <label for="fecha_inicio_enfermedad">Fecha de inicio de la
                                    enfermedad:</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_enfermedad" name="motivo_enfermedad" rows="4" cols="50"
                                    required></textarea>
                            </div>
        ...
        <div class="modal fade" id="aplazamientoExamenModal" tabindex="-1" role="dialog"
            aria-labelledby="aplazamientoExamenModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="aplazamientoExamenModalLabel">Solicitud de
                            Aplazamiento de Exámenes</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="cambioProgramaFormacionModal" tabindex="-1" role="dialog"
            aria-labelledby="cambioProgramaFormacionModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="cambioProgramaFormacionModalLabel">Solicitud de
                            Cambio de Programa de Formación</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="formCambioProgramaFormacion" method="POST" action="procesar_cambio_programa.php">
                            ...
                            <div class="form-group">
                                <label for="id_nueva_carrera">Nueva programa de formacion
                                    Solicitado:</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_cambio" name="motivo_cambio" rows="4" cols="50"
                                    class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="expectativas">Expectativas y Objetivos:</label>
                                <textarea id="expectativas" name="expectativas" rows="4" class="form-control"
                                    required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="plan_estudio">Plan de Estudio Propuesto:</label>
                                <textarea id="plan_estudio" name="plan_estudio" rows="4"
        ...
        <div class="modal fade" id="solicitudRevisionResultadosModal" tabindex="-1" role="dialog"
            aria-labelledby="solicitudRevisionResultadosModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="solicitudRevisionResultadosModalLabel">Solicitud de
                            Revisión de Resultados</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="formRevisionResultados" method="POST" action="procesar_revision_resultados.php">
                            ...
                            <p>Para constancia se firma en Pereira a los <input type="date" id="fecha_firma"
                                    name="fecha_firma" class="form-control" required>.
                            </p>
        ...
        <div class="modal fade" id="modalSolicitudCambioGrupo" tabindex="-1"
            aria-labelledby="modalSolicitudCambioGrupoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudCambioGrupoLabel">Solicitud de Cambio
                            de Grupo</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudCambioGrupo" method="POST" action="procesar_solicitud.php">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_cambio_grupo" name="motivo_cambio_grupo" rows="4" cols="50"
                                    required></textarea>
                            </div>
        ...
        <div class="modal fade" id="modalSolicitudCambioJornada" tabindex="-1"
            aria-labelledby="modalSolicitudCambioJornadaLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudCambioJornadaLabel">Solicitud de
                            Cambio de Jornada</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudCambioJornada" method="POST" action="procesar_solicitud.php">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_cambio_jornada" name="motivo_cambio_jornada" rows="4" cols="50"
                                    required></textarea>
                            </div>
                    ...
                    <div class="modal-body">
                        <form id="formInscripcion" method="POST" action="procesar_inscripcion.php">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_matricula" name="motivo_matricula" rows="4" cols="50"
                                    class="form-control" required></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal fade" id="reconocimientoCreditosModal" tabindex="-1" role="dialog"
            aria-labelledby="reconocimientoCreditosModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="reconocimientoCreditosModalLabel">Solicitud de
                            Reconocimiento de Créditos</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="formReconocimientoCreditos" method="POST"
                            action="procesar_reconocimiento_creditos.php">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="id_carrera_solicitada">Carrera a la que se solicita el
                                    reconocimiento:</label>
                                <select id="id_carrera_solicitada" name="id_carrera_solicitada" class="form-control"
                                    required>
                                    <option value="1">Carrera 1</option>
                                    <option value="2">Carrera 2</option>
                                    <!-- Agrega más opciones según tus necesidades -->
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_reconocimiento" name="motivo_reconocimiento" rows="4" cols="50"
                                    class="form-control" required></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal fade" id="becaModal" tabindex="-1" role="dialog" aria-labelledby="becaModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form id="formBeca" method="POST" action="procesar_solicitud_beca.php">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_beca" name="motivo_beca" rows="4" cols="50" class="form-control"
                                    required></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal fade" id="solicitudPracticasProfesionalesModal" tabindex="-1" role="dialog"
            aria-labelledby="solicitudPracticasProfesionalesModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="solicitudPracticasProfesionalesModalLabel">Solicitud
                            de Prácticas Profesionales</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitud" method="POST" action="procesar_solicitud.php">
                            ...
                            <div class="form-group">
                                <label for="cargo_solicitado">Cargo Solicitado:</label>
                                <input type="text" id="cargo_solicitado" name="cargo_solicitado" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="programa_academico">Programa académico:</label>
                                <input type="text" id="programa_academico" name="programa_academico"
                            ...
                            <div class="form-group">
                                <label for="apoyo_economico">Apoyo económico:</label>
                                <input type="text" id="apoyo_economico" name="apoyo_economico" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="lugar_practica">Lugar en que se desarrollará la
                                    práctica:</label>
                                <input type="text" id="lugar_practica" name="lugar_practica" class="form-control"
                                    required>
                            </div>
        ...
        <div class="modal fade" id="modalSolicitudCambioInstructor" tabindex="-1"
            aria-labelledby="modalSolicitudCambioInstructorLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudCambioInstructorLabel">Solicitud de
                            Cambio de Instructor</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudCambioInstructor" method="POST" action="procesar_solicitud.php">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_cambio_tutor" name="motivo_cambio_tutor" rows="4" cols="50"
                                    required></textarea>
                            </div>
        ...
        $(document).ready(function() {
            $('#tipo_solicitud').change(function() {
                var selectedOption = $(this).children('option:selected').val();
                if (selectedOption ===
                    'Solicitud de Extensión de Plazo para Entrega de Trabajos') {
        ...
        <div class="modal fade" id="modalSolicitudExtensionPlazo" tabindex="-1"
            aria-labelledby="modalSolicitudExtensionPlazoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudExtensionPlazoLabel">Solicitud de
                            Extensión de Plazo para Entrega de Trabajos</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudExtensionPlazo" method="POST" action="procesar_solicitud.php">
                            <h3>Estimado Estudiante:</h3>
                            <p>A continuación, puede realizar su solicitud de extensión de plazo para la
                                entrega de trabajos:</p>
                            <div class="form-group">
                                <label for="nombre">Nombre Completo:</label>
                                <input type="text" id="nombre" name="nombre" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="motivo_extension" name="motivo_extension" rows="4" cols="50"
                                    required></textarea>
                            </div>
        ...
        $(document).ready(function() {
            $('#tipo_solicitud').change(function() {
                ...
                if (selectedOption === 'Solicitud de Aprobación de Proyecto') {
                    $('#modalSolicitudAprobacionProyecto').modal(
                        'show'); // Abre el modal
                }
            });
        });
        ...
        <div class="modal fade" id="modalSolicitudAprobacionProyecto" tabindex="-1"
            aria-labelledby="modalSolicitudAprobacionProyectoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalSolicitudAprobacionProyectoLabel">Solicitud de
                            Aprobación de Proyecto de Grado</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formSolicitudAprobacionProyecto" method="POST" action="procesar_solicitud.php"
                            enctype="multipart/form-data">
                            <h3>Estimado Estudiante:</h3>
                            <p>A continuación, puede realizar su solicitud de aprobación de proyecto de
                                grado:</p>
                            ...
                            <div class="form-group">
                                <label for="archivo_proyecto">Archivo del proyecto
                                    (opcional):</label><br>
    ...
    $('#formSolicitud').on('submit', function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#solicitudPracticasProfesionalesModal').modal(
                    'hide'); // Cerrar el modal después de enviar
...
$(document).ready(function() {
    ...
    $('#formRevisionResultados').on('submit', function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('Solicitud enviada exitosamente');
                $('#solicitudRevisionResultadosModal').modal(
                    'hide'); // Cerrar el modal después de enviar
                // Aquí puedes realizar acciones adicionales después del envío
            },
            error: function(xhr, status, error) {
