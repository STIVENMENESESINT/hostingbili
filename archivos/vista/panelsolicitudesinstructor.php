    ...
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <nav class="navbar navbar-dark bg-primary">
                                <!-- Navbar content -->
                                <li>
                                    <a href="panelsolicitudesdesdeintructor.php">
                        ...
                        <li>
                            <a href="panelsolicitudesadministrativasdesdeinstructor.php">
                        ...
                        <div class="col-sm-4">
                            ...
                            <li>
                            <a href="panelsolicitudesdesdeintructor.php" class="nav-link nav-item-hover">
                ...
                <nav class="navbar navbar-dark bg-success">
                    <!-- Navbar content -->
                    <a href="paneldeinserciondesdeinstructor.php" class="btn btn-primary" id="btnRegresar">
                    Regresar
                </a>
                </nav>
            </div>
