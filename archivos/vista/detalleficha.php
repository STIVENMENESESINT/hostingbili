                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>
                                    ...
                                    <a href="EditarFicha.php? id_ficha=' . $row['id_ficha'] . '" class="btn btn-sm btn-primary">Editar</a>
                                  
                                  
                                  
                                    <button class="btn btn-sm btn-danger btn-eliminar" data-id="' . $row['id_ficha'] . '">Eliminar</button>
                                  </td>';
                            echo '</tr>';
                        }
                    } else {
