                        ...
                        <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-primary btn-agregar-tiposolicitud"
        data-id="<?php echo $fila['id_tiposolicitud']; ?>"
        onclick="window.location.href='agregartipodesolicitud.php?id=<?php echo $fila['id_tiposolicitud']; ?>';">
    agregar
</button>

                                    <!-- Botones de acción -->
                                    <button type="button" class="btn btn-primary btn-editar-tiposolicitud" data-id="<?php echo $fila['id_tiposolicitud']; ?>">Editar</button>
                                    <button type="button" class="btn btn-danger btn-eliminar-tiposolicitud"
        data-id="<?php echo $fila['id_tiposolicitud']; ?>"
        onclick="window.location.href='eliminartiposdesolicitud.php?id=<?php echo $fila['id_tiposolicitud']; ?>';">
    Eliminar
</button>
                    ...
                    <a href="agregartipodesolicitud.php" class="btn btn-success">Agregar Nuevo Tipo de Solicitud</a>
