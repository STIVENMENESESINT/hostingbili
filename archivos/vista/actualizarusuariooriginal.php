                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="numeroiden" name="numeroiden" value="<?php echo htmlspecialchars($fila['numeroiden']); ?>">
                                </div>
                                <div class="col-sm-6">
                                    <label for="id_doc" class="col-form-label">Tipo Documento:</label>
                                    <select class="form-control" id="id_doc" name="id_doc" title='' style='cursor:pointer;'></select>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-6">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="cod_poblado" name="cod_poblado" title='' style='cursor:pointer;'></select>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    <label for="direccion" class="col-form-label">Dirección:</label>
                                    <input type="text" class="form-control" id="direccion" name="direccion" value="<?php echo htmlspecialchars($fila['direccion']); ?>">
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="<?php echo htmlspecialchars($fila['fecha_nacimiento'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-6">
