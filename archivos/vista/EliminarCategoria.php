...
if (isset($_SESSION['id_userprofile'])) {
    ...
    if ($resultadoCategoria) {
        // Recuperar los datos de las categorías
        $categoriaDatos = mysqli_fetch_all($resultadoCategoria, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    <!-- Sección para mostrar y editar los datos de las categorías -->
                    <h1>Listado de Categorías</h1>
                    <div id="categoria-lista">
                        <?php foreach ($categoriaDatos as $categoria) { ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    <h5 class="card-title">Categoría: <?php echo $categoria['nombre']; ?></h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#categoria-lista').on('click', '.btn-eliminar-categoria', function () {
                ...
                if (confirm('¿Estás seguro de que deseas eliminar esta categoría?')) {
                    ...
                    $.post("../../include/ctrlIndex3.php", {
                        ...
                        if (data.rst === "1") {
                            ...
                            alert('Error al eliminar la categoría: ' + data.ms);
                        }
                    }, 'json');
                }
            });
