...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Ausencia por Enfermedad</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Ausencia por Enfermedad</h2>
    <form action="procesar_ausencia.php" method="POST">
        ...
        <label for="fecha">Fecha de ausencia:</label><br>
        <input type="date" id="fecha" name="fecha" required><br><br>

        <label for="motivo">Motivo de la ausencia:</label><br>
        <textarea id="motivo" name="motivo" rows="4" required></textarea><br><br>

        <label for="adjunto">Documento adjunto (opcional):</label><br>
