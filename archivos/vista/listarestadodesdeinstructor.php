...
<head>
    ...
    <title>listar estados desde instructor</title>
...
<body>
    <div class="layout">
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    <!-- Sección para mostrar y editar los estados -->
                        ...
                        <?php foreach ($estados as $estado) { ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <!-- Botones de acción -->
                                    <button type="button" class="btn btn-primary btn-editar-estado"
                                        data-id="<?php echo $estado['id_estado']; ?>">Editar</button>
                                        <button type="button" class="btn btn-info btn-detalles-tipo-documento"
                                        data-id="<?php echo $tipoDocumento['id_doc']; ?>">Detalles</button>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#estados-lista').on('click', '.btn-editar-estado', function () {
            ...
            $('#estados-lista').on('click', '.btn-eliminar-estado', function () {
                var estadoId = $(this).data('id');
