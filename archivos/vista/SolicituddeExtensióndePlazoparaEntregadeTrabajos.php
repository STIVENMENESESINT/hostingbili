...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Extensión de Plazo para Entrega de Trabajos</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Extensión de Plazo para Entrega de Trabajos</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="fecha_entrega_actual">Fecha de entrega actual:</label><br>
        <input type="date" id="fecha_entrega_actual" name="fecha_entrega_actual" required><br><br>

        <label for="nueva_fecha_entrega">Nueva fecha de entrega solicitada:</label><br>
        <input type="date" id="nueva_fecha_entrega" name="nueva_fecha_entrega" required><br><br>
