...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Cambio de Instructor</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Cambio de Instructor</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="instructor_actual">Instructor actual:</label><br>
        <input type="text" id="instructor_actual" name="instructor_actual" required><br><br>

        <label for="nuevo_instructor">Nuevo instructor solicitado:</label><br>
        <input type="text" id="nuevo_instructor" name="nuevo_instructor" required><br><br>
