...
<head>
    ...
    <title>listar competencia desde instructor</title>
...
<body>
    <div class="layout">
        ...
        onclick="window.location.href='agregarcompetenciadesdeinstructor.php?id=<?php echo $competencia['id_competencia']; ?>';">
    Agregar
</button>
                                    ...
                                    <button type="button" class="btn btn-primary btn-editar-competencia"
                                        data-id="<?php echo $competencia['id_competencia']; ?>">Editar</button>
                ...
                </div>       <a href="agregarcompetenciadesdeinstructor.php" class="btn btn-success">Agregar Solicitud De Crear Nueva  Competencia</a> 
            </div>
        </div>
