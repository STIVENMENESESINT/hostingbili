...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Cambio de Jornada</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Cambio de Jornada</h2>
    <form action="procesar_cambio_jornada.php" method="POST">
        ...
        <label for="curso">Curso o programa:</label><br>
        <input type="text" id="curso" name="curso" required><br><br>

        <label for="jornada_actual">Jornada actual:</label><br>
        <select id="jornada_actual" name="jornada_actual" required>
            <option value="">Seleccionar jornada actual</option>
            <option value="Mañana">Mañana</option>
            <option value="Tarde">Tarde</option>
            <option value="Noche">Noche</option>
        </select><br><br>

        <label for="nueva_jornada">Nueva jornada solicitada:</label><br>
        <select id="nueva_jornada" name="nueva_jornada" required>
            <option value="">Seleccionar nueva jornada</option>
            <option value="Mañana">Mañana</option>
            <option value="Tarde">Tarde</option>
            <option value="Noche">Noche</option>
        </select><br><br>
