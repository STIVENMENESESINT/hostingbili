                        ...
                        <?php foreach ($roles as $rol) { ?>
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-primary btn-crear-rol"
        data-id="<?php echo $rol['id_rol']; ?>"
        onclick="window.location.href='AgregarRol.php?id=<?php echo $rol['id_rol']; ?>';">
    Crear
</button>
        ...
        data-id="<?php echo $rol['id_rol']; ?>"
        onclick="window.location.href='EliminarRol.php?id=<?php echo $rol['id_rol']; ?>';">
    Eliminar
</button>
                ...
                </div>                    <a href="AgregarRol.php" class="btn btn-success">Agregar Rol</a>
