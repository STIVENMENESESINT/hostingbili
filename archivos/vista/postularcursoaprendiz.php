        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    ...
                    <h1>Postular  a una lista de espera para un futuro programa de formación</h1>
