...
<head>
    ...
    <title>listar desde instructor</title>
        ...
        <div class="layout__content">
            <div class="content__page">
                <div id="contenido">
                    ...
                    <div class="container">
        <h1>Panel De Inicio Desde Instructor</h1>
        <div class="row">
            <div class="col-sm-4">
                <ul class="navbar-nav">
                    <li>
                        <a href="listarprogramadeformaciondesdeinstructor.php" class="nav-link nav-item-hover">
                    ...
                    <li>
                                           <a href="solicitudinstructor.php" class="nav-link nav-item-hover">
                    ...
                    <li>
                <a href="noticiasdesdeinstructor.php"class="nav-link nav-item-hover">
                <i class="fas fa-file-alt fa-fw fa-lg"></i>
                    ...
                    <li>
                        <a href="listarresultadosaprendizajedesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-book-open fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Resultado de Aprendizaje</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarcompetenciadesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-trophy fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Competencia</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarMCERdesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-list-alt fa-fw fa-lg"></i>
                            <span class="nav-item">Listar MCER</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarfichadesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-file-alt fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Ficha</span>
                        </a>
                    </li>
                    <li>
                        <a href="listartipossdesolicituddesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-file-alt fa-fw fa-lg"></i>
            ...
            <div class="col-sm-4">
                <ul class="navbar-nav">
                    <li>
                        <a href="listarjornadadesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-hourglass-start fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Jornada de Formación</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarnivelformaciondesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-award fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Nivel Formación</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarmodalidaddesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-check-double fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Modalidad</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarestadodesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-flag fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Estado al Sistema</span>
                        </a>
                    </li>
                    <li>
                        <a href="listarcategoriadesdeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-folder fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Categoría</span>
                        </a>
                    </li>
                    <li>
                        <a href="listargenerodesdeintructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-venus-mars fa-fw fa-lg"></i>
                            <span class="nav-item">Listar Género</span>
                        </a>
                    </li>
                    <li>
                        <a href="listardocumentosdesdeinstructor.php" class="nav-link nav-item-hover">
            ...
            <div class="col-sm-4">
                <ul class="navbar-nav">
                    <li>
                        <a href="listarroldesdeinstructor.php" class="nav-link nav-item-hover">
                    ...
                    <li>
                        <a href="listarpoblaciondesdeinstructor.php" class="nav-link nav-item-hover">
                ...
                <i class="fas fa-file-alt fa-fw fa-lg"></i>
                    ...
                    <li>
                        <a href="enviarmensajeinstructor.php" class="nav-link nav-item-hover">
                            <i class="fas fa-file-alt fa-fw fa-lg"></i>
