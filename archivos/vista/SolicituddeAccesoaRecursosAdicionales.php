...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Acceso a Recursos Adicionales</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Acceso a Recursos Adicionales</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="recurso_solicitado">Recurso adicional solicitado:</label><br>
        <textarea id="recurso_solicitado" name="recurso_solicitado" rows="4" required></textarea><br><br>
