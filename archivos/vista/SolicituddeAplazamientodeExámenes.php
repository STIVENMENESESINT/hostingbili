...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Solicitud de Aplazamiento de Exámenes</title>
    <!-- Enlaza aquí tu hoja de estilos CSS si la tienes -->
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h2>Solicitud de Aplazamiento de Exámenes</h2>
    <form action="procesar_solicitud.php" method="POST">
        ...
        <label for="curso">Curso o asignatura:</label><br>
        <input type="text" id="curso" name="curso" required><br><br>

        <label for="fecha_examen">Fecha del examen original:</label><br>
        <input type="date" id="fecha_examen" name="fecha_examen" required><br><br>

        <label for="nueva_fecha">Nueva fecha solicitada:</label><br>
        <input type="date" id="nueva_fecha" name="nueva_fecha" required><br><br>

        <label for="motivo">Motivo del aplazamiento:</label><br>
