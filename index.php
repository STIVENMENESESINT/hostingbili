         ...
         <div class="card-body">
             ...
             <div class="form-group">
                 ...
                 <div class="input-with-icon">
                     ...
                     <input type="password" class="form-control" id="clave" name="clave" title='' placeholder="********"
                         style='cursor:pointer;'>
                 </div>
             </div>


             <!-- parte final del login -->
             ...
             <div class="card-footer" style="background-color: #ffffff;">
                 <button type="button" id="btnEntrar" name="btnEntrar"
                     class="btn btn-success w-100 d-block mx-auto mb-3">
                     Ingresar
                 </button>
                 <span class="no-account">¿No tiene una cuenta?</span>
                 <span id="registerLink" class="register-link" style="cursor: pointer;" data-bs-toggle="modal"
                     data-bs-target="#registroUsuario">Regístrate ahora</span>
                 <a href="#" id='linkOlvideClave' class="btn btn-link olvide-clave-link" data-bs-toggle="modal"
                     data-bs-target="#RestablecerContraseña">¿Olvidó su contraseña?</a>
         ...
         <div class="modal-dialog modal-sl modal-dialog-scrollable">
             <div class="modal-content">
                 ...
                 <div class="modal-header">
                     <h5 class="title" id="exampleModalLabel">Registrate: </h5>
                     ...
                     <div class="modal-body">
                         ...
                         <div id="formEmpresa" style="display: none;">
                             <div class="form-container">
                                 ...
                                 <!-- REPRESENTANTE LEGAL -->
                                 <div class="form-group">
                                     <h3 for="representante" class="form-label"> <strong>Representante Legal</strong>
                                     </h3>
                                 </div>
                                 <!-- Nombres y Apellidos -->
                                 <div class="form-group">
                         ...
                         <div id="formRegisUsu">
                             <div class="form-content">
                                 <div class="form-column">
                                     <div class="form-group">
                                         <label for="nameusu" class="form-label">Nombres:</label>
                                         <input type="text" class="form-input" id="nameusu" name="nameusu"
                                             title="Primer Nombre" style="cursor:pointer;">
                                     </div>
                                     <div class="form-group">
                                         <label for="apellidoUsu" class="form-label">Apellidos:</label>
                                 ...
                                 <div class="form-column">
                                     ...
                                     <div class="form-group">
                                         <label for="correo_registro" class="form-label">Correo Electrónico:</label>
                                         <input type="text" class="form-input" id="correo_registro"
